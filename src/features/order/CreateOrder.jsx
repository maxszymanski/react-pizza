...
function CreateOrder() {
    ...
    return (
        <div className="px-4 py-6">
            ...
            {/* Form tworzy nową nawigację i przysłać dalej */}
            <Form method="POST">
                ...
                <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
                    ...
                    {!position.latitude && !position.longitude && (
                        <span className="absolute right-[3px] top-8 z-50 md:top-1">
                            <Button
                                type="small"
                ...
                <div>
                    <input
                        type="hidden"
                        name="cart"
                        value={JSON.stringify(cart)} // tworzymy ukryty input z value z katry z zamówieniami jako tablice obiektów z pizzaItems/
                    />
                    <input
                        type="hidden"
                        name="position"
                        value={
                            position.latitude && position.longitude
                                ? `${position.latitude}, ${position.longitude}`
                                : ''
                        } // tworzymy ukryty input z value adressem z z Formularza jesli jest z geolokalizacji
                    />
...
export async function action({ request }) {
    ...
    const order = {
        ...data, //data to całe nasze info z formularza
        cart: JSON.parse(data.cart), // nasza karta z ukrytego inputa
